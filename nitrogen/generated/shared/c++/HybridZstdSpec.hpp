...
namespace margelo::nitro::zstd {
  ...
  class HybridZstdSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<ArrayBuffer> compressBytes(const std::shared_ptr<ArrayBuffer>& data, double compressionLevel) = 0;
      virtual std::shared_ptr<ArrayBuffer> decompressBytes(const std::shared_ptr<ArrayBuffer>& data) = 0;
